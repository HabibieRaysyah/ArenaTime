...
<head>
    ...
    <title>Daftar - ArenaTime.id</title>
    <!-- Font Awesome -->
    ...
    <div class="register-container">
        <div class="register-card">
            <div class="card-header">
                ...
                <h1>Bergabung Dengan Arena</h1>
                <p>Mulai petualangan olahragamu bersama kami</p>
            </div>
            ...
            <div class="card-body">
                <form action="{{ Route('register.signup') }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="input-wrapper">
                            <i class="fas fa-lock input-icon"></i>
                            <input type="password" name="password_confirmation" class="form-input" id="confirmPassword"
                    ...
                    <div class="terms-group">
                        <input type="checkbox" class="terms-checkbox" id="termsCheck" required>
                        <label for="termsCheck" class="terms-label">
                            Saya setuju dengan <a href="#">syarat dan ketentuan</a> serta <a
    ...
    <script>
        ...
        function checkPasswordStrength(password) {
            ...
            if (password.length === 0) {
                ...
                strengthText.innerHTML = '<span>Kekuatan kata sandi</span>';
            } else if (strength <= 2) {
                strengthFill.classList.add('strength-weak');
                strengthText.innerHTML = '<span>Kata sandi lemah</span>';
            } else if (strength === 3) {
                strengthFill.classList.add('strength-medium');
                strengthText.innerHTML = '<span>Kata sandi sedang</span>';
            } else {
                strengthFill.classList.add('strength-strong');
                strengthText.innerHTML = '<span>Kata sandi kuat!</span>';
            }
        }
        ...
        function checkPasswordMatch() {
            ...
            if (confirmPassword.length === 0) {
                ...
                matchText.innerHTML = '<i class="fas fa-check-circle"></i> Kata sandi cocok';
                matchText.style.color = 'var(--success)';
            } else {
                matchText.innerHTML = '<i class="fas fa-times-circle"></i> Kata sandi tidak cocok';
