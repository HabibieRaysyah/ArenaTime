                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action btn-search" onclick="showModal({{ $schedule }})">
                                    <i class="fa-solid fa-magnifying-glass"></i>
                                </button>
                                <a class="btn-action btn-edit" href="{{ Route('staff.schedules.edit', $schedule->id) }}">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('staff.schedules.destroy', $schedule->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
