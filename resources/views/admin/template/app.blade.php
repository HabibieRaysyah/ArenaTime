        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                    ...
                    <ul class="menu-items">
                        <li class="menu-item">
                            <a href="{{ route('admin.dashboard') }}"
                                class="menu-link @if (request()->path() == '/admin') active @endif">
                        ...
                        <li class="menu-item">
                            <a href="{{ route('admin.fields.index') }}"
                                class="menu-link @if (request()->path() == 'admin/fields') active @endif">
                        ...
                        <li class="menu-item">
                            <a href="{{ Route('admin.staffs.index') }}"
                                class="menu-link @if (request()->path() == 'admin/staff') active @endif">
                ...
                <div class="menu-section">
                    ...
                    <ul class="menu-items">
                        <li class="menu-item">
                            <a href="#" class="menu-link @if (request()->path() == 'admin/dashboard') active @endif">
