...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('admin.fields.index') }}" class="btn btn-outline">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <form action="{{ route('admin.fields.restore', $field->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form action="{{ route('admin.fields.deletepermanent', $field->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
