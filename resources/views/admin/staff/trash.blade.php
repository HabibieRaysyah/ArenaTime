...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('admin.staffs.index') }}" class="btn btn-outline">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <form action="{{ route('admin.staffs.restore', $user->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form action="{{ route('admin.staffs.deletepermanent', $user->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
