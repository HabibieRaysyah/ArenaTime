...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('admin.staffs.export') }}" class="btn btn-outline">
                <i class="fas fa-download"></i>
                Export
            </a>
            <a href="{{ route('admin.staffs.trash') }}" class="btn btn-recyle" >
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 class="table-title">Daftar Staff</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ Route('admin.staffs.edit', $user->id) }}" class="btn-action btn-edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.staffs.delete', $user->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn-action btn-delete" onclick="deleteData(1)">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </form>
                            </div>
